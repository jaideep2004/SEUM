...
export default function MonitoringReportsPage() {
  return (
    <div style={{ padding: 60, textAlign: "center" }}>
      ...
      <h1 style={{ margin: "0 0 8px", fontSize: 20, fontWeight: 700, color: "var(--color-text-primary)" }}>Monitoring Reports</h1>
      <p style={{ margin: "0 0 24px", fontSize: 14, color: "var(--color-text-secondary)" }}>
        This is just MonitoringReportsPage content, it is on the way.
      </p>
