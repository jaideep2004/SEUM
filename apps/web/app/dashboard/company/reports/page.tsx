...
export default function CompanyReportsPage() {
  return (
    <div style={{ padding: 60, textAlign: "center" }}>
      ...
      <h1 style={{ margin: "0 0 8px", fontSize: 20, fontWeight: 700, color: "var(--color-text-primary)" }}>Company Reports</h1>
      <p style={{ margin: "0 0 24px", fontSize: 14, color: "var(--color-text-secondary)" }}>
        This is just CompanyReportsPage content, it is on the way.
      </p>
