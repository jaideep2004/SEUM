...
export default function SubscriptionsPage() {
  return (
    <div style={{ padding: 60, textAlign: "center" }}>
      ...
      <h1 style={{ margin: "0 0 8px", fontSize: 20, fontWeight: 700, color: "var(--color-text-primary)" }}>Subscriptions</h1>
      <p style={{ margin: "0 0 24px", fontSize: 14, color: "var(--color-text-secondary)" }}>
        This is just SubscriptionsPage content, it is on the way.
      </p>
