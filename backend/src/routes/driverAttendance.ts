...
router.get('/list', authenticate, requireRole('super_admin', 'company_admin', 'fleet_manager', 'operations_manager', 'hr_manager'), attendanceController.list);
router.post('/manual', authenticate, requireRole('super_admin', 'company_admin', 'hr_manager'), attendanceController.manualCorrection);
router.get('/summary', authenticate, requireRole('super_admin', 'company_admin', 'fleet_manager', 'hr_manager'), attendanceController.monthlySummary);
